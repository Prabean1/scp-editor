...
// No Wikidot language mode: it'd conflict with CodeMirror's Markdown mode (`+` vs `#`
// headers, `//x//` vs `*x*` italics), and a wrong-but-plausible highlighter is worse than none.
